package com.example.a3listacrud;
...
public class UsersRecycleAdapter extends RecyclerView.Adapter<UsersRecycleAdapter.ViewHolder> {
    ...
    public UsersRecycleAdapter(Context context, ArrayList<UsersItem> usersItemArrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.textCounty.setText("Country :" + users.getUserCountry());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder (@NonNull View itemView){
            ...
            textCounty = itemView.findViewById(R.id.textCountry);
